...
| **Integration type — TERTIARY (RETIRED 2026-06-09)** | ~~Composio `highlevel` toolkit~~ — Composio is deprecated workspace-wide (see workspace CLAUDE.md); never used in practice. If PIT and Windsor are both unavailable, stop and report. |
