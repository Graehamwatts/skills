...
- **Triggered by signals from `content-calendar`** (future) — if a listing has been on market past its market-velocity threshold and is showing performance signals consistent with overpricing, content-calendar could surface the listing for a price-reduction a