#!/usr/bin/env python3
"""ARCHIVED 2026-09-13: the avatar-era compositor (HeyGen 4K render + alpha webm + wide strip,
punch-in crops, evidence inserts, b-roll frame folders, stickers, warm grade, whip-blur).
Kept for the in-session HeyGen pipeline in references/production-pipeline.md. Hardcoded to the
ROAD Act job (avatar_road3_4k.mp4, vo_mix_road4.wav, alignment_road2.json, 25 fps).
For CapCut exports use compositor_template.py (settings block at the top).
"""
