...
7. **Recommended Price / Offer** — three range boxes (Conservative / Competitive / Stretch), positioning visual, recommended strategy paragraph. In Past-Client mode these are relabeled "Likely range / Most-likely value today / Top of range in strong condition."
