#!/usr/bin/env python3
"""Pre-generated production content for each format in the EPA Two Years dashboard.
Paired with build_dashboard_v2.py — these strings are the 'finished' deliverables
that appear in the Copy Content button. Copy Prompt is still available for regeneration."""

CONTENT = {}

CONTENT["yt-long-pt1"] = """═══ LONG-FORM SCRIPT — YouTube (Target: ~4:30) ═══
...
<speak>
<prosody rate="medium">East Palo Alto was called the murder capital of America.</prosody>
<break time="500ms"/>
<prosody rate="slow" pitch="low">That was 1992.</prosody>
<break time="700ms"/>
...
Here's the number most people don't know. In 1992, East Palo Alto had <prosody rate="slow">42 homicides</prosody> in a city of 24,000 people. That's the highest per capita murder rate in the United States. For one year. And that headline stuck — for three decades.
<break time="800ms"/>
...
But here's what happened that didn't make national news. Starting in the mid-2000s, East Palo Alto did something most cities don't do — they stopped treating crime as a policing problem and started treating it as a community problem.
<break time="500ms"/>
The city expanded community partnerships. Built prevention programs around youth and workforce development. Modernized policing techniques. And — critical — they got neighborhood engagement plugged directly into city departments. Not as a PR move. <prosody rate="slow">As the actual operating model.</prosody>
<break time="700ms"/>
And slowly — over a decade — the numbers changed. Quietly. Without a press cycle.
<break time="1000ms"/>

On April 17, 2026 — last Thursday — the city officially marked <prosody rate="slow" pitch="low">two full years without a homicide.</prosody>
<break time="600ms"/>
...
CONTENT["production-brief"] = """═══ PRODUCTION BRIEF — EPA TWO YEARS HOMICIDE-FREE ═══
...
DUE: 48 hours post-shoot (for Monday April 20 publish if topic replaces EPA Under $1M)"""

CONTENT["yt-short"] = """═══ YOUTUBE SHORT — VERTICAL CUT (~33s) ═══
...
#EastPaloAlto #BayAreaRealEstate #PeninsulaRealEstate #EPA #SiliconValleyRealEstate"""

CONTENT["ig-reel-1"] = """═══ INSTAGRAM REEL #1 — HOOK-LED (~30s) ═══
...
CONTENT["ig-reel-2"] = """═══ INSTAGRAM REEL #2 — DATA-LED (~20s) ═══
...
AUDIO: Use original audio for this topic. The gravity of the 1992 context undermines if paired with trending audio. Optional: quiet ambient under spoken word only."""

CONTENT["blog"] = """═══ BLOG POST — SEO + AEO OPTIMIZED ═══
...
CONTENT["gmb"] = """East Palo Alto just hit a milestone almost nobody outside the city is talking about — two full years without a homicide, as of April 17, 2026.
...
IMAGE: AI-generate a clean golden-hour EPA residential street establishing shot (see AI Prompt 1 in Production Brief)."""

CONTENT["facebook"] = """Most people on the Peninsula still carry around a 1992 headline about East Palo Alto.
...
CONTENT["linkedin"] = """The Peninsula real estate market fragmented in April 2026 — and most market commentary is missing it.
...
═══ HASHTAGS ═══
#BayAreaRealEstate #PeninsulaRealEstate #EastPaloAlto #PropertyValuation #HousingMarket #MarketUpdate #RealEstateAnalysis #SiliconValleyRealEstate #RelocationBuyers #PeninsulaMarket"""

CONTENT["ad-copy"] = """═══ FACEBOOK / INSTAGRAM ADS (3 Variants) ═══
...
FAIR HOUSING COMPLIANCE: Meta Housing Special Ad Category MUST be enabled on all campaigns. Targeting cannot include demographic variables (age range acceptable 25-54 as lifestyle proxy)."""

CONTENT["email"] = """═══ WEEKLY EMAIL NEWSLETTER LEAD SECTION ═══
